...
//     <title>Tiktok</title>
//     <g id="Icon/Social/tiktok-color" stroke="none" stroke-width="8" fill="none" fill-rule="evenodd">
...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://linkedin.com/in/shubhamdesai03",
    color: "#0A66C2",
    gradient: "from-[#0A66C2] to-[#0077B5]",
    isPrimary: true
  },
  {
    ...
    subText: "@Shubham",
    icon: Github,
    url: "https://github.com/ShubhamDesai2003",
    color: "#ffffff",
    gradient: "from-[#333] to-[#24292e]"
  }
];
