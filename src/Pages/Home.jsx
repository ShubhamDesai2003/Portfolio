...
const WORDS = ["Software Developer", "Fullstack Enthusiast"];
const TECH_STACK = ["Java", "SQL", "React", "Node.js", "Express.js", "MongoDB", "MySQL"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/ShubhamDesai2003" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/shubhamdesai03/" },
  { icon: Mail, link: "mailto:shubhamdesaai01@gmail.com" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Creating innovative, functional, and user-friendly web solutions with a focus on fullstack development.
                </p>
